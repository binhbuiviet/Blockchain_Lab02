...
contract DEX {
    ...
    mapping(address => uint256) liquidity; //tracks user address to liquidity pool tokens minted
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(sent, "tokenToEth(): reverted ETH transfer.");
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        //     "deposit(): reverted token transfer"
        // );
    ...
    function withdraw(uint256 amount) public returns (uint256 ethAmount, uint256 tokenAmount) {
        ...
        require(sent, "withdraw(): reverted ETH transfer");
        require(token.transfer(msg.sender, tokenAmount), "withdraw(): reverted token transfer");
